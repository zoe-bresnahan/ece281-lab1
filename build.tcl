...
#
# build.tcl: Tcl script for re-creating project 'thirtyoneday'
#
# Generated by Vivado on Fri Jan 06 10:54:45 -0700 2023
...
#    "/src/hdl/thirtyOneDayMonth_tb.vhd"
#
...
set _xil_proj_name_ "thirtyoneday"
...
set files [list \
 [file normalize "${origin_dir}/src/hdl/thirtyOneDayMonth.vhd" ]\
]
...
set file "hdl/thirtyOneDayMonth.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "thirtyonedaymonth" -objects $obj
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/hdl/thirtyOneDayMonth_tb.vhd" ]\
]
...
set file "hdl/thirtyOneDayMonth_tb.vhd"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "thirtyOneDayMonth_tb" -objects $obj
